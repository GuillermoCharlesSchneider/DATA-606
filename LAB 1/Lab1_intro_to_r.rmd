...
**Insert your answer here**
**There seems to be a positive increasing trend of girls baptized over the years**

```{r plot-girls-vs-year-line-2}
ggplot(data = arbuthnot, aes(x = year, y = girls)) + 
  geom_line() +
...
**There are sightly more boys than girls being baptized each year, but that difference seems to be decreasing over the years**
```{r plot-total-vs-year-2}
...
**Arbuthnot covered 82 years, where our Present dataset covers 63 years. They're of a similar magnitude**
...
**Arbuthnot's observation about boys being born in greater proportion than girls still holds true. But that difference seems to be decreasing over the years**
```{r}
